...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Decipher_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 93, 10) // "computeAES"
    ...
    "computeElGamal\0computeRabin\0computeAES"
};
...
void *Decipher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Decipher.stringdata))
