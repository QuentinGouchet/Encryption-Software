...
QT_MOC_LITERAL(4, 34, 10) // "computeDSA"

    },
    "Verify\0computeRSA\0\0computeElGamal\0"
    "computeDSA"
};
...
const QMetaObject Verify::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Verify.data,
      qt_meta_data_Verify,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
